	component Computer_System is
		port (
			...
			uart_external_beginbursttransfer   : in    std_logic                     := 'X';             -- beginbursttransfer
			uart_external_writeresponsevalid_n : out   std_logic                                         -- writeresponsevalid_n
		);
	...
	u0 : component Computer_System
		port map (
			...
			uart_external_beginbursttransfer   => CONNECTED_TO_uart_external_beginbursttransfer,   --        uart_external.beginbursttransfer
			uart_external_writeresponsevalid_n => CONNECTED_TO_uart_external_writeresponsevalid_n  --                     .writeresponsevalid_n
		);
