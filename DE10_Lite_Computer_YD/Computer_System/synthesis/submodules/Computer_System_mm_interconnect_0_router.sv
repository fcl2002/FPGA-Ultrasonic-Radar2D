...
(
    ...
    localparam PAD2 = log2ceil(64'h400000c - 64'h4000008); 
    localparam PAD3 = log2ceil(64'h4000010 - 64'h400000c); 
    ...
    // ( 0x4000008 .. 0x400000c )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 32'h4000008  && write_transaction  ) begin
            src_channel = 21'b00000000000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x400000c .. 0x4000010 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 32'h400000c  && read_transaction  ) begin
